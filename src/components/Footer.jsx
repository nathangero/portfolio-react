export default function Footer() {
    ...
    return (
      <footer
        className="navbar justify-content-center bg-dark text-white m-0"
        style={styles.footer}
      >
        <ul className="list-group list-group-horizontal list-unstyled">
          <li className="mx-4">
            <a
              target="_blank"
              rel="noreferrer"
              href="https://github.com/nathangero"
              role="button"
          ...
          <li className="mx-4">
            <a
              target="_blank"
              rel="noreferrer"
              href="https://www.linkedin.com/in/nathan-geronimo/"
              role="button"
          ...
          <li className="mx-4">
            <a
              target="_blank"
              rel="noreferrer"
              href="https://medium.com/@nathanageronimo"
              role="button"
              aria-label="medium site icon"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="45"
