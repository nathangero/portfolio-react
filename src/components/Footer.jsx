            ...
            <ul className="list-group list-group-horizontal list-unstyled">
                <li className="mx-4">
                    <a target="_blank" href="https://github.com/nathangero" role="button">
                        <svg xmlns="http://www.w3.org/2000/svg" width="45" height="auto" fill="white" className="bi bi-github" viewBox="0 0 16 16">
                ...
                <li className="mx-4">
                    <a target="_blank" href="https://www.linkedin.com/in/nathan-geronimo/" role="button">
                        <svg xmlns="http://www.w3.org/2000/svg" width="45" height="auto" fill="white" class="bi bi-linkedin" viewBox="0 0 16 16">
                ...
                <li className="mx-4">
                    <a target="_blank" href="https://medium.com/@nathanageronimo" role="button">
                        <svg xmlns="http://www.w3.org/2000/svg" width="45" height="auto" fill="white" class="bi bi-medium" viewBox="0 0 16 16">
