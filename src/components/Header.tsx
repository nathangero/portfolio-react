      ...
      <nav className="sticky top-0 bg-blue-500 p-4 shadow-md z-10">
        ...
        {isOpen && (
          <div className="md:hidden mt-2 space-y-2 flex flex-col items-center">
            <button onClick={() => scrollToSection('about-me')} className="block text-white text-xl hover:text-gray-300">About</button>
            <button onClick={() => scrollToSection('projects')} className="block text-white text-xl hover:text-gray-300">Projects</button>
            <NavLink
              to={"/resume"}
